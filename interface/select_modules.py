...
class SelectModules:
    ...
    def setup_buttons(self):
        ...
        self.btn_install.grid(row=12, column=1, sticky='e')
    ...
    def set_recommended(self):
        ...
        self.modules['OCCT'].update_image(True)
        # check if amd maybe?
